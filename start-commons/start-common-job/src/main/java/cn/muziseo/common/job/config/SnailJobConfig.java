package cn.muziseo.common.job.config;
...
import cn.muziseo.common.job.config.properties.SnailJobServerProperties;
    ...
    private void registerServer() {
        ...
        if (StringUtils.isNotBlank(serverName)) {
            ...
            if (CollUtil.isNotEmpty(instances)) {
                ...
                System.out.println("获取的服务地址为：" + instance.getHost());
